                        ...
                        <div class="col-md-9">
                            <div class="card p-2">
                                <ul class="nav nav-pills mb-3" id="pills-tab" role="tablist">
                                    ...
                                    <li class="nav-item" role="presentation">
                                        <button class="nav-link" id="pills-profilem-tab" data-bs-toggle="pill"
                                            data-bs-target="#pills-profilem" type="button" role="tab"
                                            aria-controls="pills-profilem" aria-selected="false">Exclusiones</button>
                                    </li>
                                    <li class="nav-item" role="presentation">
                                ...
                                <div class="tab-content" id="pills-tabContent">
                                    ...
                                    <div class="tab-pane fade" id="pills-profilem" role="tabpanel"
                                        aria-labelledby="pills-profilem-tab">
                                        <div class="card-body p-0">
                                            <table class="table">
                                                <thead>
                                                    <tr>
                                                            ...
                                                            <div class="active tab-pane" id="activity">
                                                                ...
                                                                <div class="post">
                                                                    <div class="user-block">
                                                                        ...
                                                                        <span class="description">Shared publicly - 7:30
                                                                            PM today</span>
                                                                    </div>
                                                                    <!-- /.user-block -->
                                                                    <p>
                                                                        ...
                                                                        designers,
                                                                        typographers and the like. Some people hate it
                                                                        and argue for
